...
/*max seq no*/
#define Si4709_IOC_NR_MAX 41	//JinoKang 2011.06.03
...
#define Si4709_IOC_MUTE_GET                   	_IOR(Si4709_IOC_MAGIC, 40, int)	//JinoKang 2011.06.03

#ifdef FMRADIO_TSP_DELAY_CONTROL
#define Si4709_IOC_TSP_SPEED_SET                        _IOW(Si4709_IOC_MAGIC, 41, unsigned int)
#endif
