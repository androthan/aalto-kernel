...
#define DEBUG 1
#define CAL 1
#define BMA222_PROC_FS 1
//#undef BMA222_PROC_FS
...
#if 0			
			bma222_get_mode(&mode);
			bma222_read_accel_xyz(&acc);
			printk("[BMA222] MODE:%d  x:%d,Y:%d,Z:%d\n",mode,acc.x,acc.y,acc.z);
#endif			
			return err;
...
void bma222_chip_init(void)
{
	...
	//BMA222_BW_7_81HZ
	//BMA222_BW_62_50HZ
	bma222_set_bandwidth(C_Three_U8X);
