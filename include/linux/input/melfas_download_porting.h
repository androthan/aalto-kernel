...
*/
#define MCSDL_GPIO_SCL_SET_OUTPUT()				gpio_direction_output(GPIO_TOUCH_I2C_SCL, 0)
#define MCSDL_GPIO_SCL_SET_INPUT()				gpio_direction_input(GPIO_TOUCH_I2C_SCL)

#define MCSDL_GPIO_SDA_SET_OUTPUT()				gpio_direction_output(GPIO_TOUCH_I2C_SDA, 0)
