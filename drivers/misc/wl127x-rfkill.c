...
//TI CHANGED Lyan 2011.10.06 BT On problem
...
//TI CHANGED Lyan 2011.10.06 BT On problem
		// Wait till the LDO stabilize
		udelay(50);
		// Wake the chip and let it to settle down for 10ms - Hoon.
		rc = gpio_direction_output(pdata->bt_nshutdown_gpio, 1);
		mdelay(10);
//TI CHANGED Lyan 2011.10.06 BT On problem		
