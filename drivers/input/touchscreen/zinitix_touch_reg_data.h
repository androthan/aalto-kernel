...
const _sain_reg_data m_reg_data[MAX_REG_COUNT] = { 
	...
	{0, 0}, // 3E, RESERVED
	{0, 0}, // 3F, RESERVED
	{2312, 1}, // 40, X00_01_DRIVE_NUM
	{2826, 1}, // 41, X02_03_DRIVE_NUM
	{3340, 1}, // 42, X04_05_DRIVE_NUM
	{3854, 1}, // 43, X06_07_DRIVE_NUM
	{4625, 1}, // 44, X08_09_DRIVE_NUM
	{256, 1}, // 45, X10_11_DRIVE_NUM
	{770, 1}, // 46, X12_13_DRIVE_NUM
	{1284, 1}, // 47, X14_15_DRIVE_NUM
	{1798, 1}, // 48, X16_17_DRIVE_NUM
	...
	{300, 1}, // 51, Y0 SENSITIVITY TH
	{300, 1}, // 52, LAST Y SENSITIVITY TH
	{300, 1}, // 53, X0 SENSITIVITY TH
	{300, 1}, // 54, LAST X SENSITIVITY TH
	...
	{8737, 1}, // 64, BDATA EDGE COEF3
	{-30601, 1}, // 65, BDATA CORNER COEF1
	...
	{0, 0}, // CE, RESERVED
	{0, 0}, // CF, RESERVED
	{1797, 1}, // D0, FREQ X NUM 0_1
	{3081, 1}, // D1, FREQ X NUM 2_3
	{4367, 1}, // D2, FREQ X NUM 4_5
	{5139, 1}, // D3, FREQ X NUM 6_7
	{5653, 1}, // D4, FREQ X NUM 8_9
	{5911, 1}, // D5, FREQ X NUM 10_11
	{5911, 1}, // D6, FREQ X NUM 12_13
	{5911, 1}, // D7, FREQ X NUM 14_15
	{10259, 1}, // D8, FREQ X NUM 16_17
