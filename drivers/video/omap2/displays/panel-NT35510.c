...
static void aat1402_set_brightness(void)
{
	...
	if(current_panel==1)	// if Hitachi 20mA
	{
		spi1writeindex(0xB0);
		spi1writedata(0x02);
	...
	else if(current_panel==5)	// if Hitachi 17mA
	{
		...
		printk(KERN_DEBUG" HITACHI 17mA PANEL! orig_intensity=%d, current_intensity=%d\n", orig_intensity, current_intensity);
