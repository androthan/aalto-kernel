...
/* This function let us know MADC is ready to work */
/* used by battery monitor which makes use of MADC for VBAT and TEMP */
static int gs_twl4030_madc_ready = 0;
int is_twl4030_madc_ready(void)
{
	return gs_twl4030_madc_ready;
}
