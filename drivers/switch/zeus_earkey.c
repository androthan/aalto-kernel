...
#define SEND_END_CHECK_COUNT	1	
#define SEND_END_CHECK_TIME get_jiffies_64() + (HZ/25)// 1000ms / 11 = 90m -> 1000ms/25 = 40ms
#define WAKE_LOCK_TIME (HZ*1)// 1000ms  = 1sec

//extern void wm1811_ear_volume_up(u16 volume);
